...
static ssize_t ft5x0x_write(struct device *dev, struct device_attribute *attr, const char *buf, size_t count)
{
  ...
  if ((buf[0]=='4') && (buf[1]=='0')) focaltechPdata2->swap_xy = 0;  	
  if ((buf[0]=='4') && (buf[1]=='1')) focaltechPdata2->swap_xy = 1;
  if ((buf[0]=='5') && (buf[1]=='0')) focaltechPdata2->xpol = 0;
  if ((buf[0]=='5') && (buf[1]=='1')) focaltechPdata2->xpol = 1;
  if ((buf[0]=='6') && (buf[1]=='0')) focaltechPdata2->ypol = 0;
  if ((buf[0]=='6') && (buf[1]=='1')) focaltechPdata2->ypol = 1; 	
