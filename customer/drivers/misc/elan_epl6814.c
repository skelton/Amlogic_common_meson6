...
static DEVICE_ATTR(elan_ls_sensor_als_ch0_rawdata, S_IROTH|S_IWOTH, elan_ls_sensor_als_ch0_rawdata_show,NULL);
static DEVICE_ATTR(elan_ls_sensor_als_ch1_rawdata, S_IROTH|S_IWOTH, elan_ls_sensor_als_ch1_rawdata_show,NULL);
static DEVICE_ATTR(elan_ls_als_lux, S_IROTH|S_IWOTH, elan_ls_als_lux_show, NULL);

static DEVICE_ATTR(elan_ls_incandescent_threshold, S_IROTH|S_IWOTH, elan_ls_incandescent_threshold_show, elan_ls_incandescent_threshold_store);
static DEVICE_ATTR(elan_ls_fluorescent_threshold, S_IROTH|S_IWOTH, elan_ls_fluorescent_threshold_show, elan_ls_fluorescent_threshold_store);
static DEVICE_ATTR(elan_ls_mix_threshold, S_IROTH|S_IWOTH, elan_ls_mix_threshold_show,elan_ls_mix_threshold_store);

static DEVICE_ATTR(elan_ls_als_ax2, S_IROTH|S_IWOTH, elan_ls_als_ax2_show, elan_ls_als_ax2_store);
static DEVICE_ATTR(elan_ls_als_bx, S_IROTH|S_IWOTH, elan_ls_als_bx_show, elan_ls_als_bx_store);
static DEVICE_ATTR(elan_ls_als_c, S_IROTH|S_IWOTH, elan_ls_als_c_show, elan_ls_als_c_store);
static DEVICE_ATTR(elan_ls_als_ax, S_IROTH|S_IWOTH, elan_ls_als_ax_show, elan_ls_als_ax_store);
static DEVICE_ATTR(elan_ls_als_b, S_IROTH|S_IWOTH, elan_ls_als_b_show, elan_ls_als_b_store);
