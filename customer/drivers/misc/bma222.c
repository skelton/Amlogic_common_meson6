...
#define SENSOR_NAME_250 		"bma250"  //for Compatible with hardware bma250 add by nick
#define ABSMIN				-512
#define ABSMAX				512
...
#else   //for Compatible with hardware bma250 add by nick 

#define BMA222_ACC_X8_LSB__POS           6
#define BMA222_ACC_X8_LSB__LEN           2
#define BMA222_ACC_X8_LSB__MSK           0xC0
#define BMA222_ACC_X8_LSB__REG           BMA222_X_AXIS_LSB_REG

#define BMA222_ACC_Y8_LSB__POS           6
#define BMA222_ACC_Y8_LSB__LEN           2
#define BMA222_ACC_Y8_LSB__MSK           0xC0
#define BMA222_ACC_Y8_LSB__REG           BMA222_Y_AXIS_LSB_REG

#define BMA222_ACC_Z8_LSB__POS           6
#define BMA222_ACC_Z8_LSB__LEN           2
#define BMA222_ACC_Z8_LSB__MSK           0xC0
#define BMA222_ACC_Z8_LSB__REG          BMA222_Z_AXIS_LSB_REG
...
//	gpio_enable_edge_int(gpio_to_idx(INT_PORT), 1, client->irq - INT_GPIO_0);
	...
	for(i=0; i<3; i++){
		printk("Read bma222 chip id %d times: %d\n",i,temp);
	        temp = i2c_smbus_read_byte_data(client, BMA222_CHIP_ID_REG);
		if(temp > 0)
			break;
	}
        if(temp>0)
	...
	if (tempvalue == BMA222_CHIP_ID || tempvalue == BMA222E_CHIP_ID) {
		printk(KERN_INFO "Bosch Sensortec Device detected!\n"
				"BMA222 registered I2C driver! id = %d\n" ,tempvalue);
	} else{
