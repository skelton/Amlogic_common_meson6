/*
 * arch/arm/mach-meson6/board-m6g11-e8.c
 *
...
{
#ifdef CONFIG_TC103
	#include "../drivers/touchscreen/firmware/GDM_Release_V2.01J.mgar"
#else
...
#ifdef CONFIG_TC103   // VCCK MAX:1.367V
...
static struct meson_cs_pdata_t vcck_pdata = {
    .meson_cs_init_data = &vcck_init_data,
    .voltage_step_table = {
        1297000, 1278000, 1259000, 1240000,
        1220000, 1201000, 1182000, 1163000,
        1144000, 1125000, 1106000, 1087000,
        1067000, 1048000, 1029000, 1010000,
    },
    .default_uV = 1220000,
};
...
static void wifi_gpio_init(void)
{
	...
	aml_clr_reg32_mask(P_PAD_PULL_UP_REG2,1<<19);	// GPIOD_3
}
...
//tmp fix by Elvis Yu
static void m6g11_e8_set_vccx2(int power_on)
{
    if (power_on) {
...
MACHINE_START(MESON6_G11_E8, "Amlogic Meson 6 g11 e8 board")
