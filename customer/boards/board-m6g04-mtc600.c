...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    .soft_limit_to99 =  0,
    .para            =  NULL,                       // para will pass to g04_pmu_call_back
...
static struct meson_cs_pdata_t vcck_pdata = {
    ...
    .voltage_step_table = {
        1378000, 1351000, 1323000, 1296000,
        1268000, 1240000, 1212000, 1185000,
        1157000, 1130000, 1102000, 1074000,
        1047000, 1019000,  991000,  963000,
    },
    .default_uV = 1378000,
};
...
static int gc0307_init(void)
{
    ...
    printk("gc0307_init OK!!!!\n");
    return 0;
}

static int gc0307_v4l2_init(void)
{
    gc0307_have_inited=1;
    gc0307_init();
}
static int gc0307_v4l2_uninit(void)
{
    gc0307_have_inited=0;
    printk( "amlogic camera driver: gc0307_v4l2_uninit. \n");
...
static struct aml_camera_i2c_fig1_s gc0307_custom_init_script[] = {
    {0x14,0x11},
    {0xff,0xff},
};
...
static void gc2015_v4l2_uninit(void)
{
    ...
    msleep(5);
    #if defined(CONFIG_VIDEO_AMLOGIC_CAPTURE_GC0307)
    if(gc0307_have_inited==0)
    #endif
        aml_set_reg32_bits(P_HHI_GEN_CLK_CNTL, 0, 8, 1); //close clock
}
...
#endif
#ifdef CONFIG_GSl2682_CAPACITIVE_TOUCHSCREEN_G04_MTC600
    {
