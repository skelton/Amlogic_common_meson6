...
#include "board-m6g38-T97203.h"
//extern int m6g38_t97203_lcd_init();
...
static struct battery_parameter g38_t97203_battery = {
...
static int g38_t97203_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    ...
    .pmu_call_back   =  g38_t97203_pmu_call_back,
    .board_battery   = &g38_t97203_battery,
};
...
static int gc0308_init(void)
{
    ...
    gpio_out(PAD_GPIOE_10, 1);    // set camera power enable,11
    msleep(20);
    ...
    // set camera power enable
    gpio_out(PAD_GPIOE_10, 0);    // set camera power enable,11
    msleep(20);
...
static int gc0308_v4l2_uninit(void)
{
    ...
    gpio_out(PAD_GPIOE_10, 1);    // set camera power disable,11,hf
    msleep(5);
...
static pinmux_item_t nt99250_pins[] = {
    {
        .reg = PINMUX_REG(9),
        .setmask = 1 << 12
    },
...
static pinmux_set_t nt99250_pinmux_set = {
    .chip_select = NULL,
    .pinmux = &nt99250_pins[0]
};
static void nt99250_init(void)
{
    pinmux_set(&nt99250_pinmux_set);

    aml_set_reg32_bits(P_HHI_GEN_CLK_CNTL, 1, 8, 5); //select XTAL as camera clock

    // reset low
    printk( "amlogic camera driver: nt99250_v4l2_init. \n");
...
static void nt99250_v4l2_disable(void)
{
...
static aml_plat_cam_data_t video_nt99250_data = {
    .name="video-nt99250",
    .video_nr=0,   //   1
    ...
    .device_disable=nt99250_v4l2_disable,
};
...
static pinmux_item_t nt99340_pins[] = {
    {
        .reg = PINMUX_REG(9),
        .setmask = 1 << 12
    },
...
static pinmux_set_t nt99340_pinmux_set = {
    .chip_select = NULL,
    .pinmux = &nt99340_pins[0]
};
static void nt99340_init(void)
{
    pinmux_set(&nt99340_pinmux_set);

    aml_set_reg32_bits(P_HHI_GEN_CLK_CNTL, 1, 8, 5); //select XTAL as camera clock

    // reset low
    printk( "amlogic camera driver: nt99340_v4l2_init. \n");
    gpio_out(PAD_GPIOZ_0, 0);
...
static void nt99340_v4l2_disable(void)
{
...
static aml_plat_cam_data_t video_nt99340_data = {
    .name="video-nt99340",
    .video_nr=0,   //    1
    ...
    .device_disable=nt99340_v4l2_disable,
};
...
#ifdef CONFIG_GPS_GNS7560
int gps_power_up(void){
	printk("gps_power_up\n");
	//gpio_out(PAD_GPIOE_9,1);
	return 0;
}

int gps_power_down(void){
	printk("gps_power_down\n");
	//gpio_out(PAD_GPIOE_9,0);
	return 0;
}

int gps_reset(int level){
	printk("gps_reset is %d\n", level);
	gpio_set_status(PAD_GPIOE_9,gpio_status_out);
	if (level) {
		gpio_out(PAD_GPIOE_9,1);
	} else {
		gpio_out(PAD_GPIOE_9,0);
...
static struct  amlogic_gps_data aml_gps = {
	.power_up = &gps_power_up,
        .power_down = &gps_power_down,
        .reset = &gps_reset
};
...
MACHINE_START(MESON6_G38_T97203, "Amlogic Meson6 g38_t97203 customer platform")
