...
#ifdef CONFIG_SND_AML_M6_RT5631
...
//    
    // reset low
    printk( "amlogic camera driver: gt2035_init. \n");
    gpio_out(PAD_GPIOZ_0, 0);
...
#if defined(CONFIG_SND_AML_M6_RT5631)
