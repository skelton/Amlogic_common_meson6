...
static struct axp_cfg_info axp_cfg = {
    ...
    .pmu_bat_para1 = 0,////0,	//3.1328
    .pmu_bat_para2 = 0,////0,	//3.2736
    .pmu_bat_para3 = 0,////0,	//3.4144
    .pmu_bat_para4 = 3,////0,	//3.5552
    .pmu_bat_para5 = 6,////0,	//3.6256
    .pmu_bat_para6 = 10,////1,	//3.6608
    .pmu_bat_para7 = 15,////8,	//3.6960
    .pmu_bat_para8 = 25,////13,	//3.7312
    .pmu_bat_para9 = 36,////22,	//3.7664
    .pmu_bat_para10 = 48,////41,	//3.8016
    .pmu_bat_para11 = 56,////52,	//3.8368
    .pmu_bat_para12 = 65,////57,	//3.8720
    .pmu_bat_para13 = 75,////71,	//3.9424
    .pmu_bat_para14 = 85,////82,	//4.0128
    .pmu_bat_para15 = 93,////90,	//4.0832
    .pmu_bat_para16 = 100,////100,	//4.1536
    .pmu_usbvol_limit = 1,
    .pmu_usbvol = 4000,
    .pmu_usbcur_limit = 0,
    .pmu_usbcur = 900,
...
static struct power_supply_info battery_data ={
    ...
    .voltage_min_design = 2900 * 1000,////2600 * 1000,  //axp_cfg.pmu_pwroff_vol * 1000,
    .energy_full_design = 7760,////3400,	//battery capability
    .use_for_apm = 1,
};
...
static struct meson_cs_pdata_t vcck_pdata = {
    ...
    .voltage_step_table = {
        1315000, 1296000, 1277000, 1257000,
        1238000, 1219000, 1200000, 1181000,
        1161000, 1142000, 1123000, 1104000,
        1085000, 1065000, 1046000, 1027000,
    },
    .default_uV = 1315000,
};
...
MACHINE_START(MESON6_G24_K8, "Amlogic Meson6 g24_k8 customer platform")
