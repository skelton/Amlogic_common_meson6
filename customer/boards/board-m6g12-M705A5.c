...
static aml_plat_cam_data_t video_gc0307_data = {
    .name="video-gc0307",
#if defined(CONFIG_VIDEO_AMLOGIC_CAPTURE_GC2015)|defined(CONFIG_VIDEO_AMLOGIC_CAPTURE_GT2005)
    .video_nr=1,   //    1
#else
    .video_nr=0,   //    1
#endif
...
#endif
#ifdef CONFIG_GSl1680_CAPACITIVE_TOUCHSCREEN_G12_ANDA_M705A5
    {
...
#define HP_UNPLUG   0
    ...
    aml_set_reg32_bits(P_PAD_PULL_UP_REG0,1,19,1);			//disable default pull-up
