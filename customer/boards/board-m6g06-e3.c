...
static struct meson_cs_pdata_t vcck_pdata = {
    ...
    .voltage_step_table = {
        1309000, 1291000, 1272000, 1254000,
        1235000, 1217000, 1199000, 1180000,
        1162000, 1143000, 1126000, 1108000,
        1089000, 1070000, 1052000, 1033000,
    },
    .default_uV = 1309000,
};
