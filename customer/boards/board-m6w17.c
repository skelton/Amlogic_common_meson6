...
static struct battery_parameter w17_battery = {
...
static int w17_pmu_call_back(void *para)
{
...
static struct axp_supply_init_data axp_sply_init_data = {
  ...
  //.led_control     =  led_control,
    ...
    .pmu_call_back   =  w17_pmu_call_back,
    .board_battery   = &w17_battery,
};
...
static struct meson_cs_pdata_t vcck_pdata = {
    ...
    .voltage_step_table = {
		1306600,	1283600,	1260300,	1236900,
		1213800,	1191300,	1167500,	1143600,
		1120300,	1096800,	1072300,	1050100,
		1027700,	1004900,	982500,		957600,
	},
    .default_uV = 1306600,
};
...
#ifdef CONFIG_GOODIX_GT82X_W17_CAPACITIVE_TOUCHSCREEN
#include <../include/linux/gt82x_w17.h>
#endif
#ifdef CONFIG_GOODIX_GT82X_W17_CAPACITIVE_TOUCHSCREEN
#include <linux/ctp.h>
...
static u8 gt82x_config[] ={0x02,0x11,0x03,0x12,0x04,0x13,0x05,0x14,0x06,0x15,0x07,0x16,0x08,0x17,0x09,0x18,0x0A,0x19,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x03,0x0D,0x04,0x0E,0x05,0x0F,0x06,0x10,0x07,0x11,0x08,0x12,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x1B,0x03,0x10,0x88,0x10,0x11,0x00,0x00,0x05,0x00,0x00,0x02,0x44,0x32,0x35,0x03,0x00,0x05,0x00,0x02,0x58,0x04,0x00,0x43,0x3C,0x3F,0x38,0x08,0x00,0x23,0x19,0x02,0x14,0x10,0x02,0x9E,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01};
#endif
...
#ifdef CONFIG_GOODIX_GT813_W17_CAPACITIVE_TOUCHSCREEN		
#include <linux/gt813_w17.h>				
#define GPIO_GOODIX_PENIRQ 	PAD_GPIOA_16 
#define GPIO_GOODIX_RST 	PAD_GPIOC_3
static struct goodix_i2c_rmi_platform_data goodix_ts_pdata = {
    .gpio_rst = GPIO_GOODIX_RST,
