...
#if 0//def CONFIG_ANDROID_TIMED_GPIO
...
static struct adc_key adc_kp_key[] = {
    {KEY_VOLUMEUP,          "vol+", CHAN_4,  9,   40},
    {KEY_VOLUMEDOWN,        "vol-", CHAN_4,  275,     40},
    //{KEY_BACK,              "back", CHAN_4, 150, 40},
...
#ifdef CONFIG_VIDEO_AMLOGIC_CAPTURE_HI253_G05
static pinmux_item_t gc0308_pins[] = {
    {
        .reg = PINMUX_REG(9),
        .setmask = 1 << 12
...
#include "board-m6g05-n1b-touch.fw_T8"
};
...
MACHINE_START(MESON6_G05_N1B, "Amlogic Meson6 g05-n1b customer platform")
