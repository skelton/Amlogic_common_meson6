#ifndef __BOARD_M6G11_N8_H_
#define __BOARD_M6G11_N8_H_
...
#define DI_ADDR_END         (DI_ADDR_START+DI_MEM_SIZE-1)
    ...
    #define PPMGR_FRAME_SIZE             1280 * 800
    #define PPMGR_BUFFER_COUNT           18 //6x3
    #ifdef CONFIG_POST_PROCESS_MANAGER_3D_PROCESS
        #define PPMGR_3D_BUFFER_COUNT        1
    #else
        #define PPMGR_3D_BUFFER_COUNT        0
    #endif
#ifdef CONFIG_POST_PROCESS_MANAGER_PPSCALER
    #define PPMGR_PPSCALER_BUFFER_COUNT  3  //1x3
#else
    #define PPMGR_PPSCALER_BUFFER_COUNT  0
#endif
#define PPMGR_MEM_SIZE    PPMGR_FRAME_SIZE*(PPMGR_BUFFER_COUNT+PPMGR_3D_BUFFER_COUNT+PPMGR_PPSCALER_BUFFER_COUNT)
#else
