...
//set status
	...
	aml_set_reg32_mask(P_PAD_PULL_UP_REG2,1<<8);	
}
...
static void sdio_extern_init(void)
{
    ...
    gpio_set_status(PAD_GPIOX_11,gpio_status_in);
    gpio_irq_set(52,GPIO_IRQ(4,GPIO_IRQ_RISING));
    #endif
...
MACHINE_START(MESON6_G06, "Amlogic Meson6 g06-848 customer platform")
