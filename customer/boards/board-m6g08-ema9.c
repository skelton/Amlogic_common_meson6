...
static struct axp_cfg_info axp_cfg = {
    ...
    .pmu_bat_para5 = 0,	//3.6256
    .pmu_bat_para6 = 1,	//3.6608
    .pmu_bat_para7 = 8,	//3.6960
    .pmu_bat_para8 = 13,	//3.7312
    .pmu_bat_para9 = 22,	//3.7664
    .pmu_bat_para10 = 41,	//3.8016
    .pmu_bat_para11 = 52,	//3.8368
    .pmu_bat_para12 = 57,	//3.8720
    .pmu_bat_para13 = 71,	//3.9424
    .pmu_bat_para14 = 82,	//4.0128
...
struct freq_opp {
    ...
    unsigned int volts_min; /* in uV */
    unsigned int volts_max; /* in uV */
};

static const struct freq_opp armcore_1200 = {
    .dev_id	    = "a9_clk",
    .freq       = 1200000,
    .prediv     = 1,
    .mult       = 19,
...
static const struct freq_opp armcore_800 = {
    .dev_id     = "a9_clk",
    .freq       = 800000,
    .prediv     = 1,
    .mult       = 17,
...
static const struct freq_opp armcore_400 = {
    .dev_id     = "a9_clk",
    .freq       = 400000,
    .prediv     = 1,
    .mult       = 17,
...
#define OPP(freq) \
    {             \
        .index = (unsigned int) &armcore_##freq,    \
        .frequency = freq * 1000, \
    }

static struct cpufreq_frequency_table armcore_freq_table[] = {
    OPP(1200),
    OPP(800),
    OPP(400),
    {
...
static int vcck_set_voltage(unsigned int index)
{
    struct freq_opp *opp;
    if (!vcck)
    {
        printk(KERN_ERR "%s: Please init vcck first!\n");
        return -ENODEV;
    }

    opp = (struct freq_opp *) cpufreq_info.freq_table[index].index;

    return regulator_set_voltage(vcck, opp->volts_min, opp->volts_max);
}
...
static struct meson_cpufreq_config cpufreq_info = {
    .freq_table = armcore_freq_table,
    .init = vcck_regulator_init,
    .set_voltage = vcck_set_voltage,
};
...
static struct adc_key adc_kp_key[] = {
    {KEY_VOLUMEUP,                 "vol+", CHAN_4, 70, 40},
    {KEY_VOLUMEDOWN,    "vol-", CHAN_4, 160, 40},
    {KEY_MENU,          "menu", CHAN_4, 275, 40},
};
...
static pinmux_item_t hi704_pins[] = {
    {
        .reg = PINMUX_REG(9),
        .setmask = 1 << 12
    },
...
static pinmux_set_t hi704_pinmux_set = {
    .chip_select = NULL,
    .pinmux = &hi704_pins[0]
};
...
{
    gpio_set_status(GPIO_FT_PWR, gpio_status_out);
    gpio_out(GPIO_FT_PWR, on);
}
...
//              (0x1 << L2X0_AUX_CTRL_NS_INT_CTRL_SHIFT))|(0x2 << L2X0_AUX_CTRL_WAY_SIZE_SHIFT), L2X0_AUX_CTRL_MASK);
      l2x0_init((void __iomem *)IO_PL310_BASE, (3<<28)|(3<<26) | (1<<11) |(1<<10)|(1<<13)|(1<<22), ~0);
#endif
}
...
#define HP_UNPLUG   0
    ...
    if(get_display_mode() != 0) {   //if !panel, return HP_PLUG
        return HP_PLUG;//modify by emdoor jim.kuang 2012-05-04 
    }
