...
#include "board-m6g12-M1006AG2GEN.h"
...
#ifdef CONFIG_FOCALTECH_CAPACITIVE_TOUCHSCREEN_G12_ANDA_M1006AG1
...
struct aml_camera_i2c_fig_s custom_gt2005_script[] = {
    {0x0101,0x03},  //  0  norma   1 h flip  2 v flip  3 180
    {0xffff,0xff}, 
};
...
static struct aml_camera_i2c_fig1_s gc2035_front_custom_init_script[] = {
    {0x17,0x17}, //0x14   normal , 0x15 h--flip, =0x16  v--flip, =0x17  180¶È
    {0xff,0xff},
};
...
#endif
#ifdef CONFIG_GSl3680_CAPACITIVE_TOUCHSCREEN_G12_ANDA_M1006
    {
