/*
 * arch/arm/mach-meson3/board-m6g11_e8-panel.c
 *
...
extern void dlight_fast_recovery(int on);
#endif

extern Lcd_Config_t m6g11_e8_lcd_config;
...
static void minilvds_ports_ctrl(Bool_t status)
{
	...
	if (status) 
	{		
		WRITE_MPEG_REG(0x202c, READ_MPEG_REG(0x202c) | (0xfe<<12));  //set tcon pinmux		
	...
	{	
		...
		WRITE_MPEG_REG(0x202c, READ_MPEG_REG(0x202c) & ~(0xfe<<12));  //clear tcon pinmux			
...
#ifdef CONFIG_TC103
Lcd_Config_t m6g11_e8_lcd_config = {
    // Refer to LCD Spec
    .lcd_basic = {
        .h_active = H_ACTIVE,
        .v_active = V_ACTIVE,
    ...
    .lcd_timing = {
        .pll_ctrl = 0x10230,  //42.9M, 50.2Hz
        .div_ctrl = 0x18803,  
        .clk_ctrl = 0x5111a,  //[19:16]ss_ctrl, [12]pll_sel, [8]div_sel, [4]vclk_sel, [3:0]xd  0x3111a
...
static struct aml_bl_platform_data m6g11_e8_backlight_data =
{
...
static struct platform_device m6g11_e8_backlight_device = {
    .name = "aml-bl",
    .id = -1,
    .num_resources = 0,
    .resource = NULL,
    .dev = {
        .platform_data = &m6g11_e8_backlight_data,
    },
};

static struct aml_lcd_platform __initdata m6g11_e8_lcd_data = {
    .lcd_conf = &m6g11_e8_lcd_config,
};

static struct platform_device __initdata * m6g11_e8_lcd_devices[] = {
    &meson_device_lcd,
//    &meson_device_vout,
    &m6g11_e8_backlight_device,
};

int  m6g11_e8_lcd_init(void)
{
    int err;	
	lcd_sync_duration(&m6g11_e8_lcd_config);
	lcd_setup_gamma_table(&m6g11_e8_lcd_config);
	lcd_video_adjust(&m6g11_e8_lcd_config);	
    meson_lcd_set_platdata(&m6g11_e8_lcd_data, sizeof(struct aml_lcd_platform));
    err = platform_add_devices(m6g11_e8_lcd_devices, ARRAY_SIZE(m6g11_e8_lcd_devices));
    return err;
}
