...
static aml_plat_cam_data_t video_gc0307_data = {
    .name="video-gc0307",
#ifdef CONFIG_VIDEO_AMLOGIC_CAPTURE_GC0307_front
    .video_nr=1,   //    1
#else
    .video_nr=1,   //    1
#endif
...
static struct aml_camera_i2c_fig1_s gc2035_custom_init_script[] = {
    //{0x17,0x14}, //0x14   normal , 0x15 h--flip, =0x16  v--flip, =0x17  180?ии
    {0xff,0xff},
};
...
static struct aml_camera_i2c_fig1_s gc2035_front_custom_init_script[] = {
   // {0x17,0x17}, //0x14   normal , 0x15 h--flip, =0x16  v--flip, =0x17  180?ии
    {0xff,0xff},
};
...
#endif
#ifdef CONFIG_GSl2680_CAPACITIVE_TOUCHSCREEN_G12_ONDA_M806A1
    {
        I2C_BOARD_INFO("gsl2680", 0x40),
    },
#endif
