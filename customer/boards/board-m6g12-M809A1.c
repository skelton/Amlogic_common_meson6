...
static pinmux_item_t gc2005_pins[] = {
    {
        .reg = PINMUX_REG(9),
        .setmask = 1 << 12
    },
...
static pinmux_set_t gc2005_pinmux_set = {
    .chip_select = NULL,
    .pinmux = &gc2005_pins[0]
};

static void gt2005_init(void)
{
    gpio_out(PAD_GPIOE_11, 1);
    pinmux_set(&gc2005_pinmux_set);
...
static struct i2c_board_info __initdata aml_i2c_bus_info_a[] = {
	...
	{
        /*gc2035 i2c address is 0x42/0x43*/
		I2C_BOARD_INFO("gc2035_i2c_front",  0x78 >> 1),
...
#endif
#ifdef CONFIG_GSl2680_CAPACITIVE_TOUCHSCREEN_G12_ONDA_M809A1
    {
